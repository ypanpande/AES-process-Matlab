function  paramaterForAICPicker
...
% % 1.wset = time window for threshold amplitude determination
 uicontrol('Parent',figg,'Style','text','String','1.window for threshold amplitude determination','Position',[0 210 250 30],'BackgroundColor',bgclr);
wsetb = uicontrol('Parent',figg,'Style','edit','String',num2str(wset),'BackgroundColor','white','Position',[0 200 250 20],'Callback',{@setFcn});
